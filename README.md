...
This package, the BardCanvas Core, contains all neccesary files to allow
BardCanvas modules and templates running on top.
...
Current version is **1.7.1.1**, released on April 19, 2017.
...
- [Core](https://github.com/BardCanvas-Core) is this repository you're on.
- [Core Modules](https://github.com/BardCanvas-Core-Modules) contains
  the most essential modules, including users and modules management,
