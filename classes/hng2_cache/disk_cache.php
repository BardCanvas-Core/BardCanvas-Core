...
class disk_cache
{
    ...
    public function __construct($target_file_path = "", $preload_data = true, $versioned = true)
    {
        global $config;
        ...
        $this->disk_cache_file = $versioned ? "$name~v{$config->disk_cache_version}.$ext" : $target_file_path;
